...
$category_type = array(
    ...
    $all = $xml_all->women->all;

    //商品情報
    $xml =  simplexml_load_file('../xml/items.xml');
    $top = $xml->women->top;
    $outer = $xml->women->outer;
    $bottom = $xml->women->bottom ;
    $shoes = $xml->women->shoes;
    $cap = $xml->women->cap;
?>
...
<div class="jender">WOMEN/<span class="jender_search"><a href="<?php echo MEN_SEARCH;?>">MEN</a></span></div>
  ...
  <nav class="category">
    <ul>
    	<li><a id="type_a" href="<?php echo WOMEN_SEARCH.'?category_type=all';?>">ALL</a></li>
    	<li><a id="type_t" href="<?php echo WOMEN_SEARCH.'?category_type=1';?>">TOP</a></li>
    	<li><a id="type_o" href="<?php echo WOMEN_SEARCH.'?category_type=2';?>">OUTER</a></li>
    	<li><a id="type_b" href="<?php echo WOMEN_SEARCH.'?category_type=3';?>">BOTTOM</a></li>
      <li><a id="type_s" href="<?php echo WOMEN_SEARCH.'?category_type=4';?>">SHOES</a></li>
    	<li><a id="type_c" href="<?php echo WOMEN_SEARCH.'?category_type=5';?>">CAP</a></li>
    </ul>
  </nav>
  <div class="clear"></div>
</header>
